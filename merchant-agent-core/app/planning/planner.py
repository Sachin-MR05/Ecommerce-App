...
class Planner:
    ...
    def _system_prompt(self, state: AgentState) -> str:
        ...
        response_contract = (
            ...
            '{"action": "ASK_USER", "clarification_question": "write your question here (e.g. Would you like to proceed with the checkout?)"}\n'
    ...
    def _parse_decision(self, raw_content: str) -> Decision:
        ...
        if isinstance(payload, dict) and "action" not in payload:
            ...
            if "status" in payload and ("razorpayOrderId" in payload or "razorpay_order_id" in payload):
                ...
                payload = {
                    ...
                    "response": f"I verified that Order #{order_id} is successfully {status}. We are now preparing your order for shipment! Thank you for your purchase!"
                ...
                payload["action"] = "FINAL_RESPONSE"
                # Map clarification_question -> response so Decision.model_validate works
                if "clarification_question" in payload and "response" not in payload:
                    payload["response"] = payload["clarification_question"]
        ...
        try:
            ...
            # Normalize tool name used directly as action
            if "action" in payload and payload["action"] not in ("TOOL_CALL", "FINAL_RESPONSE", "ASK_USER", "SELECT_PRODUCT"):
